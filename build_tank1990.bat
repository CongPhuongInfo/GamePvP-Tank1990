...
"%VBC%" /nologo /target:winexe /out:%OUTEXE% /optimize+ /optionstrict+ /optionexplicit+ ^
    ...
    Program.vb Form1.vb TankGame.vb NetworkPeer.vb
...
if errorlevel 1 (
    ...
    echo [LUU Y] Nho copy thu muc "sprites" vao cung thu muc voi %OUTEXE%
    echo          neu khong, game se tu dong fallback ve bang GDI+ hinh hoc.
)
